...
/// FMData Exception.
/// </summary>
public class FMDataException : Exception
{
    /// <summary>
    /// The internal FileMaker error code that was received.
    /// </summary>
    public int FMErrorCode { get; set; }

    /// <summary>
    /// FileMaker Error Message from: https://help.claris.com/en/pro-help/content/error-codes.html
    /// </summary>
    public string FMErrorMessage
    {
        get
        {
            return _errorMessages[FMErrorCode];
        }
    }

    private readonly Dictionary<int, string> _errorMessages = new()
    {
        { -1, "Unknown error" },
        { 0, "No error" },
        ...
        { 953, "Exceeded limit on data the FileMaker Data API and OData can transmit (*)" },
        ...
        { 1214, "A function parameter contains an expression where a field is required" },
        ...
        { 1552, "Returned by plug-ins; see the documentation that came with the plug-in" },
        { 1553, "Returned by plug-ins; see the documentation that came with the plug-in" },
        { 1554, "Returned by plug-ins; see the documentation that came with the plug-in" },
        { 1555, "Returned by plug-ins; see the documentation that came with the plug-in" },
        { 1556, "Returned by plug-ins; see the documentation that came with the plug-in" },
        { 1557, "Returned by plug-ins; see the documentation that came with the plug-in" },
        { 1558, "Returned by plug-ins; see the documentation that came with the plug-in" },
        { 1559, "Returned by plug-ins; see the documentation that came with the plug-in" },
        ...
        { 1702, "Authentication information wasn’t provided in the correct format; verify the value of the Authorization header (*)" },
        ...
        { 1712, "Private key file already exists; remove it and run the command again (*)" },
    ...
    /// <summary>
    /// Creates a new instance of the FMData Exception class.
    /// </summary>
    public FMDataException()
    {
    }
    ...
    /// Creates a new instance of the FMData Exception class.
    /// </summary>
    public FMDataException(string message) : base(message)
    {
    }
    ...
    /// Creates a new instance of the FMData Exception class.
    /// </summary>
    public FMDataException(string message, Exception innerException) : base(message, innerException)
    {
    }
    ...
    /// Creates a new instance of the FMData Exception class.
    /// </summary>
    public FMDataException(int fmErrorCode, string message, Exception innerException) : base(message, innerException)
    {
